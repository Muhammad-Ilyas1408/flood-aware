"""Situation Analysis page: dataset, village, and shelter overview from the API."""
...
st.set_page_config(
    page_title="Situation Analysis - Flood-Aware", page_icon="🗺️", layout="wide"
)

st.title("Situation Analysis")
st.write(
